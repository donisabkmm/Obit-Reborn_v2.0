...
import AnniversaryStories from './AnniversaryStories.jsx'
...
function AnniversaryIndex() {
    ...
    useEffect(()=>{
        try {
            if (permissions.some(item =>item ===15))
            {
                setPermission(true);
            }
            else
    ...
    if (dak) {
        return (
            ...
            <div className="wrapper" >
                ...
                {permission?(
<Topnav pageHead={"Anniversary Stories"} />):(<Topnav pageHead={"Anniversary Stories"} />)}
