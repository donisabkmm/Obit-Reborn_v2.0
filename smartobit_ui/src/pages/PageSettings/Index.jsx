...
function PageSettingsIndex() {
    ...
    useEffect(()=>{
        try {
            if (permissions.some(item =>item ===5))
            {
                setPermission(true);
            }
            else
    ...
    if (dak) {
        return (
            ...
            <div className="wrapper" >
                ...
                {permission?(
                <Topnav pageHead={"Page Settings"} />):(<Topnav pageHead={"Page Settings"} />)}
...
export default PageSettingsIndex;
