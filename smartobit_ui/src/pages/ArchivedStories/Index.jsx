...
import ArchivedStories from './ArchivedStories.jsx'
...
function ArchivedIndex() {
    ...
    useEffect(()=>{
        try {
            if (permissions.some(item =>item ===14))
            {
                setPermission(true);
            }
            else
    ...
    if (dak) {
        return (
            ...
            <div className="wrapper" >
                ...
                {permission?(
<Topnav pageHead={"Archived Stories"} />):(<Topnav pageHead={"Archived Stories"} />)}
