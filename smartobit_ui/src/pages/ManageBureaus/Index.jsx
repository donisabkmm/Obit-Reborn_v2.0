...
import ManageBureaus from './ManageBureaus.jsx'
import {useEffect, useState} from 'react'
import {toast} from 'react-toastify'


function ManageBureausIndex() {
    ...
    useEffect(() => {
        try {
            if (permissions.some(item => item === 3)) {
                setPermission(true);
            }
    ...
    if (dak) {
        return (
            ...
            <div className="wrapper">
                ...
                {permission ? (
                    <Topnav pageHead={"Manage Bureaus"}/>) : (<Topnav pageHead={"Manage Bureaus"}/>)}
...
export default ManageBureausIndex;
