...
function RecentStoriesIndex() {
    ...
    useEffect(()=>{
        try {
            if (permissions.some(item =>item ===12))
            {
                setPermission(true);
            }
            else
    ...
    if (dak) {
        return (
            ...
            <div className="wrapper" >
                ...
                {permission?(
                <Topnav pageHead={"Recent Stories"}  />):(<Topnav pageHead={"Recent Stories"}  />)}
...
export default RecentStoriesIndex;
